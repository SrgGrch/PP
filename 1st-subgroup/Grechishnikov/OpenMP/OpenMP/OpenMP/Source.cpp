...
void RunSimulation(const int nTimeSteps, const int nBodies)
{
	...
	real_t* ay;
	real_t* mass;
	rx = (real_t*)_mm_malloc(nBodies * sizeof * rx, 32);
	ry = (real_t*)_mm_malloc(nBodies * sizeof * ry, 32);
	vx = (real_t*)_mm_malloc(nBodies * sizeof * vx, 32);
	vy = (real_t*)_mm_malloc(nBodies * sizeof * vy, 32);
	ax = (real_t*)_mm_malloc(nBodies * sizeof * ax, 32);
	ay = (real_t*)_mm_malloc(nBodies * sizeof * ay, 32);
	mass = (real_t*)_mm_malloc(nBodies * sizeof * mass, 32);
